...
if (!$allresults) {
    die("<h3 class='text-danger'>Query failed: " . mysqli_error($conn) . "</h3>");
}

//  Check if any results exist before counting rows
$row = (mysqli_num_rows($allresults) > 0) ? mysqli_num_rows($allresults) : 0;
