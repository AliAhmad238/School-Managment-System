                        ...
                        <table class="table table-hover">
                            ...
                            ?>
                                 ...
                                 */
                                 ...
                                 $crud = new Database($dbhost, $dbuser, $dbpass, $dbname);
                                 ...
                                 if (isset($_POST['add_fees'])) {
                                     extract($_POST);
                                     $class_id = strtolower($class_id);
                                     $addfeesSQL = "INSERT INTO `feescollection`(`student_id`, `student_name`, `Class`, `Session`, `fees_cat`, `due_fees`, `current_fees`, `total_fees`, `PaidAmount`, `due_balance`, `Date`, `receipt_no`, `Remarks`) 
                                                    VALUES ('$std_id','$std_name','$class_id','$session_id','$feescat','$due_fees','$curent_fees','$total_fees','$paid_ammount','$due_balance', now(), '$receipt', '$remarks')";
                                 
                                     $returnSMS = $crud->insert($addfeesSQL);
                                     if ($returnSMS) {
                                         echo "<h2 class='text-success'>Fees Added Successfully</h2>";
                                     } else {
                                         echo "<h2 class='text-danger'>Error Adding Fees, Please Try Again!!</h2>";
                                     }
                                 }
